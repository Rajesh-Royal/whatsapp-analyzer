  ...
  return (
    <>
      ...
      <div className="flex h-full w-full flex-col items-center justify-center">
        ...
        />
        <Section classNames="max-w-[800px]">
        ...
        <Button
          ...
          title="If you haven't uploaded a file then you will be seeing only the example data on the dashboard my-5"
        >
          Go to dashboard
        </Button>
      </div>
...
const WhatsappChatExportHowTo = () => {
  return (
    <div className="">
      <h1 className="text-2xl">How to export chat history ❓</h1>
      <div>
