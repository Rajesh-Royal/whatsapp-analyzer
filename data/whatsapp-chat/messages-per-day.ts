...
export interface MessagesPerDayResultType {count: number, data: string | Date}
...
export const getMessagesPerDay = async (fromDate?: string, toDate?: string, author?: string | null,  offset?: number, limit?: number) => {
