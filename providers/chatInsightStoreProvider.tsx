...
import { type ChatInsightStore, createChatInsightStore } from '@/stores/ChatInsightsStore'

export const ChatInsightStoreContext = createContext<StoreApi<ChatInsightStore> | null>(
  null,
)
